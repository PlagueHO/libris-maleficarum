...
/// <summary>
/// Tests for <see cref="CreateWorldEntityRequestValidator"/>.
/// </summary>
[TestClass]
[TestCategory("Unit")]
public class CreateWorldEntityRequestValidatorTests
{
    private CreateWorldEntityRequestValidator _validator = null!;
    ...
    public void Setup()
    {
        _validator = new CreateWorldEntityRequestValidator();
    }
