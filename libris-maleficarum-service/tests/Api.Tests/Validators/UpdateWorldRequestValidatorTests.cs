...
/// <summary>
/// Tests for <see cref="UpdateWorldRequestValidator"/>.
/// </summary>
[TestClass]
public class UpdateWorldRequestValidatorTests
{
    private UpdateWorldRequestValidator _validator = null!;
    ...
    public void Setup()
    {
        _validator = new UpdateWorldRequestValidator();
    }
