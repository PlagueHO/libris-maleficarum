...
/// <summary>
/// Tests for <see cref="CreateEntityRequestValidator"/>.
/// </summary>
[TestClass]
public class CreateEntityRequestValidatorTests
{
    private CreateEntityRequestValidator _validator = null!;
    ...
    public void Setup()
    {
        _validator = new CreateEntityRequestValidator();
    }
