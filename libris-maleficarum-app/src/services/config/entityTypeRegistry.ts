...
export const ENTITY_TYPE_REGISTRY = [
  ...
  },
  {
    ...
    propertySchema: [
      ...
      },
      {
        ...
        label: 'Race/Species',
        type: 'text',
        placeholder: 'e.g., Human, High Elf, Half-Orc...',
        maxLength: 100,
      },
      {
        key: 'Class',
      ...
      },
      {
        ...
        label: 'Subclass',
        type: 'text',
        placeholder: 'e.g., Champion, School of Evocation, Arcane Trickster...',
        maxLength: 100,
      },
      {
        key: 'Level',
      ...
      },
      {
        ...
        label: 'Background',
        type: 'text',
        placeholder: 'e.g., Sage, Noble, Criminal...',
        maxLength: 100,
      },
      {
        key: 'Alignment',
      ...
      },
      {
        ...
        label: 'Personality Traits',
        type: 'textarea',
        placeholder: 'Describe key personality characteristics and mannerisms...',
        maxLength: 500,
      },
      {
        key: 'Ideals',
        label: 'Ideals',
        type: 'textarea',
        placeholder: 'Describe the principles and beliefs that guide this character...',
        maxLength: 500,
      },
      {
        key: 'Bonds',
        label: 'Bonds',
        type: 'textarea',
        placeholder: 'Describe important attachments to people, places, or causes...',
        maxLength: 500,
      },
      {
        key: 'Flaws',
        label: 'Flaws',
        type: 'textarea',
        placeholder: 'Describe character weaknesses and vulnerabilities...',
        maxLength: 500,
      },
      {
        key: 'Backstory',
        label: 'Backstory',
        type: 'textarea',
        placeholder: 'Character history, origin, and formative life events...',
        maxLength: 2000,
      },
      {
        key: 'Appearance',
        label: 'Appearance',
        type: 'textarea',
        placeholder: 'Physical description and notable visual traits...',
        maxLength: 500,
      },
      {
        key: 'Factions',
        label: 'Factions',
        type: 'tagArray',
        placeholder: 'Add a faction...',
        description: 'Organizations, guilds, or groups this character is affiliated with',
        maxLength: 50,
      },
      {
        ...
        description: 'Signature gear and important possessions',
        maxLength: 50,
      },
      {
        ...
        type: 'tagArray',
        placeholder: 'Add an ability...',
        description: 'Key abilities, spells, or iconic talents',
        maxLength: 50,
      },
      {
        key: 'Languages',
      ...
      },
      {
        ...
        type: 'tagArray',
        placeholder: 'Add a relationship...',
        description: 'Important allies, rivals, mentors, or family ties',
        maxLength: 50,
      },
    ],
  },
  {
    ...
    icon: 'Users',
    schemaVersion: 1,
    suggestedChildren: ['Character', 'PlayerCharacter', 'Location', 'Event', 'Quest'],
    propertySchema: [
      {
        key: 'FactionType',
        label: 'Faction Type',
  ...
  },
  {
    ...
    icon: 'Calendar',
    schemaVersion: 1,
    suggestedChildren: ['Event', 'Location', 'PlayerCharacter'],
    propertySchema: [
      {
        key: 'SessionNumber',
  ...
  },
  {
    ...
    icon: 'Users',
    schemaVersion: 1,
    suggestedChildren: ['Character', 'PlayerCharacter', 'Faction'],
    canBeRoot: true,
  },
  {
    type: 'Events',
