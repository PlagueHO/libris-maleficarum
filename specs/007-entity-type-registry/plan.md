...
2. Create `ENTITY_TYPE_REGISTRY` array with all 29 entity types:
   - Geographic: Continent, Country, Region, City, Building, Room, Location
   - Characters: Character, Faction
   - Events: Event, Quest
   - Items: Item
   - Campaigns: Campaign, Session
   - Containers: Folder, Locations, People, Events, History, Lore, Bestiary, Items, Adventures, Geographies
   - Regional: GeographicRegion, PoliticalRegion, CulturalRegion, MilitaryRegion
   - Other: Other
...
3. Test icon name format (PascalCase):
   ...
   ```
4. Test completeness (all 29 types present):
   ```typescript
